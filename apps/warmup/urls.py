...
warmup_target_import_channel_template = WarmupTargetViewSet.as_view({"post": "import_channel_template"})
...
urlpatterns = [
    ...
    path("targets/import-channel-template/", warmup_target_import_channel_template, name="warmup-target-import-channel-template"),
