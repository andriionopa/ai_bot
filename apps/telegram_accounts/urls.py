...
from apps.telegram_accounts.views import AccountRoleTemplateViewSet, GGRViewSet, ProxyViewSet, TelegramAccountViewSet
...
router.register("ggr", GGRViewSet, basename="ggr")
